...
const CompRepCasosExitosos = () => {
    ...
    const URI = ULR_BASE + "Reportes/CasosExitos/";
        ...
        <div className="card bg-light text-dark mb-3" >
                <div className="card-header">     
                    ...
                    <div className="row  justify-content-center">
                        ...
                        <div className="col-5">
                            <CSVLink  data={dataChart} filename={`TablaCasosExitosos_${fechaInicio}_${fechaFin}`}  > 
                ...
                <div className="card-body ">
                    ...
                    <p className="card-text ">
                        ...
                        <div className='row justify-content-center'>
                            <div className='col-8'>  <h6>Casos exitosos
                                </h6>  </div>
                        </div>
...
export default  CompRepCasosExitosos;