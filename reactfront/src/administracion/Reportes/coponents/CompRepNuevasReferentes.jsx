...
const CompRepNuevasReferentes = () => {
    ...
    const URI = ULR_BASE+"Reportes/NuevasReferentes/";
                    ...
                    <p className="card-text ">
                        ...
                        <BarChart
                            ...
                            <CartesianGrid strokeDasharray="3 3" />
                             <Bar dataKey="Nuevas referentes" fill="#8884d8" background={{ fill: "#eee" }} />
                            </BarChart>
                        ...
                        <div className='row justify-content-center'>
                            <div className='col-8'>  <h6>Nuevas referentes</h6>  </div>
                        </div>
...
export default  CompRepNuevasReferentes;